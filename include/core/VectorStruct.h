...
struct My_Vector2
{
    ...
    inline My_Vector2(const My_Vector2 &other) : x(other.x), y(other.y)
    {
    }
...
struct My_Vector3
{
    ...
    inline My_Vector3(const My_Vector3 &other) : x(other.x), y(other.y), z(other.z)
    {
    }
    ...
    {
        return target.x > min.x && target.x < max.x && target.y > min.y && target.y < max.y && target.z > min.z && target.z < max.z;
    }
};
...
struct My_Vector4
{
    ...
    inline My_Vector4(const My_Vector4 &other) : x(other.x), y(other.y), z(other.z), w(other.w)
    {
    }
